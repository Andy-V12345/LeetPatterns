...
export default function RecapCard({ patternStats, createNewProblem }: RecapCardProps) {
  	return (
		...
		<div className="self-end flex gap-4">
			<button onClick={createNewProblem} className="bg-theme-orange text-foreground font-semibold px-4 py-2 rounded hover:bg-theme-hover-orange">
				Continue Practicing
			</button>
		</div>
		</div>
